...
class BookingController extends AbstractController
{
    ...
    public function booking_place(string $type, string $slug, Request $request, PositionRepository $positionRepository, TypeRepository $typeRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($availabilityForm->isSubmitted() && $availabilityForm->isValid()) {
            ...
            if (!$this->checkAvailability($position, $checkin, $checkout)) {
                ...
                // enregistre les données de réservation dans la session
                ...
                $booking->setAdultPool($request->request->get('adultPool'));
                $booking->setChildPool($request->request->get('childPool'));
                $bookingForm = $this->createForm(BookingType::class, $booking);

                // Affiche le formulaire de détail de la réservation
                return $this->render('booking/booking_detail.html.twig', [
                    'position' => $position,
        ...
        return $this->render('booking/booking_search_availability.html.twig', [
            'position' => $position,
    ...
    #[Route('/reservation/infos-client', name: 'booking_customer_infos')]
    public function booking_customer_infos(Request $request, SessionInterface $session): Response
    {
        ...
        return $this->render('booking/booking_customer_infos.html.twig', [
            'booking' => $booking,
    ...
    public function booking_summary(SessionInterface $session): Response
    {
        ...
        return $this->render('booking/booking_summary.html.twig', [
            'booking' => $booking,
            'customer' => $customer,
            ]);
    }
    ...
    public function booking_confirmation(SessionInterface $session): Response
    {
        ...
        // Affiche une page de confirmation pour la réservation
        return $this->render('booking/booking_confirmation.html.twig', [
